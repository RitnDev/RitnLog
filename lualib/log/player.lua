...
local function globalIgnore(setting)
    local playerIgnore = not global.settings.all_option
    if playerIgnore == false then playerIgnore = not setting end
    return playerIgnore
end

local function on_player(e)
    local playerIgnore = globalIgnore(global.settings.all_option_player)
    RitnEvent:new(e):setIgnore(playerIgnore):log()
end
...
local function on_player_created(e)
    local playerIgnore = globalIgnore(global.settings.option_player_admin)
    RitnEvent:new(e):setIgnore(playerIgnore):createGlobalPlayer():log()
end
...
local function on_player_changed_force(e)
    local playerIgnore = globalIgnore(global.settings.option_player_admin)
    RitnEvent:new(e):playerChangedForce():setIgnore(playerIgnore):log()
end
...
local function on_player_changed_surface(e)
    local playerIgnore = globalIgnore(global.settings.option_player_admin)
    RitnEvent:new(e):playerChangedSurface():setIgnore(playerIgnore):log()
end
...
local function on_player_left_game(e)
    local playerIgnore = globalIgnore(global.settings.option_player_admin)
    RitnEvent:new(e):playerLeftGame():setIgnore(playerIgnore):log()
end
...
local function on_player_banned(e)
    local playerIgnore = globalIgnore(global.settings.option_player_admin)
    RitnEvent:new(e):playerBanned():setIgnore(playerIgnore):log()
end
...
local function on_player_unbanned(e)
    local playerIgnore = globalIgnore(global.settings.option_player_admin)
    RitnEvent:new(e):playerUnbanned():setIgnore(playerIgnore):log()
end
...
local function on_player_kicked(e)
    local playerIgnore = globalIgnore(global.settings.option_player_admin)
    RitnEvent:new(e):playerKicked():setIgnore(playerIgnore):log()
end
...
local function on_player_died(e)
    local playerIgnore = globalIgnore(global.settings.option_player_admin)
    RitnEvent:new(e):playerDied():setIgnore(playerIgnore):log()
end
...
local function on_player_cursor_stack_changed(e)
    local ignoreCursor = globalIgnore(global.settings.cursor_stack_option)
    RitnEvent:new(e):setIgnore(ignoreCursor):playerCursorChanged():log()
end
...
local function on_player_changed_position(e)
    ...
    local ignorePosition = globalIgnore(global.settings.position_option)
    RitnEvent:new(e):setIgnore(ignorePosition):playerChangedPosition():log()
end
...
local function on_player_display_scale_changed(e)
    local playerIgnore = globalIgnore(global.settings.all_option_player)
    RitnEvent:new(e):playerDisplayScaleChanged():setIgnore(playerIgnore):log()
end
